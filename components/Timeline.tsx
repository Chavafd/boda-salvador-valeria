...
const timelineEvents = [
  ...
  },
  {
    ...
    icon: FaGlassCheers,
    description: 'Piña colada, cantarito y música de maracuya',
  },
  {
    time: '5:15 PM',
    title: 'Ingreso de Invitados',
    icon: FaHeart,
    description: 'Recepción de invitados al salón',
  },
  {
    time: '5:30 PM',
    title: 'Entrada de Novios',
    icon: FaHeart,
    description: 'Llegada de los novios',
  },
  {
    time: '5:35 PM',
    title: 'Banquete a Tres Tiempos',
    icon: FaUtensils,
    description: 'Servicio de tres tiempos, vals, novio + mamá, novia + papá, novios',
  },
  {
    time: '7:35 PM',
    title: 'Pista de Baile',
    icon: FaMusic,
    description: 'Se abre la pista de baile, DJ con iluminación',
  },
  {
    time: '11:00 PM',
    title: 'Cierre',
    icon: FaHeart,
    description: 'Termina el evento',
  },
]
